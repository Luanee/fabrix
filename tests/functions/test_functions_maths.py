...
def test_abs(ctx: Context, expr: str, expected: int | float) -> None:
    assert evaluate(expr, ctx) == expected
...
def test_round(ctx: Context, expr: str, expected: int | float) -> None:
    assert evaluate(expr, ctx) == expected
...
def test_ceiling(ctx: Context, expr: str, expected: int | float) -> None:
    assert evaluate(expr, ctx) == expected
...
def test_floor(ctx: Context, expr: str, expected: int | float) -> None:
    assert evaluate(expr, ctx) == expected
